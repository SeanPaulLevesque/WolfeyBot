...
| 7 | EndgameStall | Protect ×0.6 when `ctx.is_threatened(slot)` and the board is a 1v1 endgame or 2v1 advantage (Protect only delays; ×0.4 → ×0.6 in 0.44.1, user-tuned — net with ProtectValue's ×2.5 is 1.5). Split out of ProtectValue |
