...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ("Incineroar", "Sneasler", "Dual Wingbeat → Sneasler", 19.85, "Switch → Basculegion", 6.78),
    ("Incineroar", "Whimsicott", "Dual Wingbeat → Whimsicott", 26.95, "Switch → Kingambit", 3.20),
    ("Incineroar", "Garchomp", "Ice Fang → Garchomp", 2.92, "Switch → Basculegion", 6.10),
    ("Incineroar", "Farigiraf", "Rock Tomb → Incineroar", 4.23, "Switch → Basculegion", 6.03),
    ("Incineroar", "Kingambit", "Protect → ?", 5.00, "Protect → ?", 5.00),
    ("Incineroar", "Aerodactyl", "Rock Tomb → Aerodactyl", 3.51, "Switch → Basculegion", 9.44),
    ...
    ("Sneasler", "Garchomp", "Dual Wingbeat → Sneasler", 19.85, "Switch → Basculegion", 1.70),
    ("Sneasler", "Kingambit", "Dual Wingbeat → Sneasler", 19.85, "Earth Power → Kingambit", 2.02),
    ("Aerodactyl", "Garchomp", "Rock Tomb → Aerodactyl", 7.02, "Switch → Basculegion", 2.36),
    ("Lopunny", "Garchomp", "Dual Wingbeat → Lopunny", 11.96, "Giga Drain → Garchomp", 1.30),
    ("Weavile", "Garchomp", "Rock Tomb → Weavile", 2.45, "Switch → Kingambit", 1.67),
    ("Talonflame", "Garchomp", "Rock Tomb → Talonflame", 56.37, "Switch → Basculegion", 8.57),
    ...
    ("Glimmora", "Incineroar", "Protect → ?", 15.00, "Switch → Garchomp", 5.27),
    ("Pelipper", "Dragonite", "Rock Tomb → Pelipper", 8.19, "Switch → Kingambit", 3.20),
...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ...
    ("Sneasler", "Garchomp", "Dual Wingbeat → Sneasler", 13.12, "Switch → Basculegion", 1.60),
    ("Sneasler", "Kingambit", "Dual Wingbeat → Sneasler", 13.12, "Earth Power → Kingambit", 2.20),
    ("Aerodactyl", "Garchomp", "Rock Tomb → Aerodactyl", 6.23, "Switch → Basculegion", 2.30),
    ...
    ("Glimmora", "Incineroar", "Switch → Garchomp", 7.67, "Earth Power → Glimmora", 9.67),
    ("Pelipper", "Dragonite", "Rock Tomb → Pelipper", 7.38, "Switch → Kingambit", 3.20),
...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ("Incineroar", "Sneasler", "Stomping Tantrum → Sneasler", 19.85, "Switch → Basculegion", 1.62),
    ("Incineroar", "Whimsicott", "Poison Jab → Whimsicott", 7.09, "Iron Head → Whimsicott", 2.37),
    ("Incineroar", "Garchomp", "Dragon Claw → Garchomp", 2.88, "Low Kick → Incineroar", 1.57),
    ("Incineroar", "Farigiraf", "Stomping Tantrum → Incineroar", 5.00, "Kowtow Cleave → Farigiraf", 6.14),
    ("Incineroar", "Kingambit", "Stomping Tantrum → Incineroar", 2.50, "Low Kick → Kingambit", 2.18),
    ("Incineroar", "Aerodactyl", "Stomping Tantrum → Incineroar", 3.75, "Iron Head → Aerodactyl", 4.55),
    ("Farigiraf", "Sneasler", "Stomping Tantrum → Sneasler", 39.69, "Kowtow Cleave → Farigiraf", 6.14),
    ("Farigiraf", "Garchomp", "Dragon Claw → Garchomp", 11.52, "Kowtow Cleave → Farigiraf", 6.14),
    ("Whimsicott", "Garchomp", "Dragon Claw → Garchomp", 8.64, "Iron Head → Whimsicott", 4.32),
    ("Whimsicott", "Kingambit", "Poison Jab → Whimsicott", 14.18, "Low Kick → Kingambit", 3.27),
    ("Sneasler", "Garchomp", "Stomping Tantrum → Sneasler", 19.85, "Switch → Basculegion", 1.62),
    ("Sneasler", "Kingambit", "Stomping Tantrum → Sneasler", 19.85, "Low Kick → Kingambit", 2.18),
    ("Aerodactyl", "Garchomp", "Dragon Claw → Garchomp", 8.64, "Iron Head → Aerodactyl", 4.55),
    ("Lopunny", "Garchomp", "Dragon Claw → Garchomp", 2.88, "Switch → Basculegion", 4.33),
    ("Weavile", "Garchomp", "Dragon Claw → Garchomp", 2.88, "Low Kick → Weavile", 3.20),
    ("Talonflame", "Garchomp", "Rock Tomb → Talonflame", 57.97, "Kowtow Cleave → Garchomp", 2.27),
    ("Charizard", "Incineroar", "Rock Tomb → Charizard", 18.13, "Low Kick → Incineroar", 1.57),
    ("Rotom-Wash", "Garchomp", "Dragon Claw → Garchomp", 5.76, "Kowtow Cleave → Rotom-Wash", 1.77),
    ("Glimmora", "Incineroar", "Stomping Tantrum → Glimmora", 23.73, "Low Kick → Incineroar", 1.57),
    ("Pelipper", "Dragonite", "Dragon Claw → Dragonite", 5.68, "Kowtow Cleave → Pelipper", 2.60),
...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ...
    ("Incineroar", "Garchomp", "Ice Fang → Garchomp", 2.92, "Switch → Basculegion", 4.37),
    ...
    ("Farigiraf", "Sneasler", "Dual Wingbeat → Sneasler", 39.69, "Switch → Basculegion", 7.32),
    ("Farigiraf", "Garchomp", "Ice Fang → Garchomp", 11.68, "Switch → Kingambit", 4.75),
    ("Whimsicott", "Garchomp", "Dual Wingbeat → Whimsicott", 53.89, "Switch → Venusaur", 4.67),
    ("Whimsicott", "Kingambit", "Dual Wingbeat → Whimsicott", 53.89, "Close Combat → Kingambit", 3.91),
    ("Sneasler", "Garchomp", "Dual Wingbeat → Sneasler", 19.85, "Switch → Basculegion", 7.34),
    ("Sneasler", "Kingambit", "Dual Wingbeat → Sneasler", 19.85, "Close Combat → Kingambit", 2.61),
    ("Aerodactyl", "Garchomp", "Rock Tomb → Aerodactyl", 7.02, "Switch → Basculegion", 8.20),
    ("Lopunny", "Garchomp", "Dual Wingbeat → Lopunny", 11.96, "Switch → Basculegion", 3.20),
    ...
    ("Rotom-Wash", "Garchomp", "Ice Fang → Garchomp", 5.84, "Switch → Garchomp", 3.90),
    ("Glimmora", "Incineroar", "Switch → Garchomp", 7.41, "Close Combat → Incineroar", 2.15),
    ("Pelipper", "Dragonite", "Rock Tomb → Pelipper", 8.19, "Switch → Kingambit", 3.74),
...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ("Incineroar", "Sneasler", "Stomping Tantrum → Sneasler", 19.85, "Earth Power → Incineroar", 1.92),
    ("Incineroar", "Whimsicott", "Poison Jab → Whimsicott", 7.09, "Sludge Bomb → Whimsicott", 5.82),
    ("Incineroar", "Garchomp", "Dragon Claw → Garchomp", 2.88, "Earth Power → Incineroar", 1.92),
    ("Incineroar", "Farigiraf", "Stomping Tantrum → Incineroar", 5.00, "Sludge Bomb → Farigiraf", 5.89),
    ("Incineroar", "Kingambit", "Stomping Tantrum → Incineroar", 2.50, "Earth Power → Kingambit", 3.30),
    ("Incineroar", "Aerodactyl", "Stomping Tantrum → Incineroar", 3.75, "Giga Drain → Aerodactyl", 3.16),
    ("Farigiraf", "Sneasler", "Stomping Tantrum → Sneasler", 39.69, "Sludge Bomb → Farigiraf", 3.92),
    ("Farigiraf", "Garchomp", "Dragon Claw → Garchomp", 11.52, "Sludge Bomb → Farigiraf", 3.92),
    ("Whimsicott", "Garchomp", "Dragon Claw → Garchomp", 8.64, "Sludge Bomb → Whimsicott", 7.93),
    ("Whimsicott", "Kingambit", "Poison Jab → Whimsicott", 14.18, "Sludge Bomb → Whimsicott", 5.82),
    ("Sneasler", "Garchomp", "Stomping Tantrum → Sneasler", 19.85, "Switch → Basculegion", 1.60),
    ("Sneasler", "Kingambit", "Stomping Tantrum → Sneasler", 19.85, "Earth Power → Kingambit", 2.20),
    ("Aerodactyl", "Garchomp", "Dragon Claw → Garchomp", 8.64, "Giga Drain → Aerodactyl", 2.37),
    ("Lopunny", "Garchomp", "Dragon Claw → Garchomp", 2.88, "Sludge Bomb → Lopunny", 1.63),
    ("Weavile", "Garchomp", "Switch → Kingambit", 5.43, "Protect → ?", 2.00),
    ("Talonflame", "Garchomp", "Rock Tomb → Talonflame", 57.97, "Giga Drain → Garchomp", 2.08),
    ("Charizard", "Incineroar", "Rock Tomb → Charizard", 18.13, "Earth Power → Incineroar", 1.92),
    ("Rotom-Wash", "Garchomp", "Dragon Claw → Garchomp", 5.76, "Giga Drain → Rotom-Wash", 2.28),
    ("Glimmora", "Incineroar", "Stomping Tantrum → Incineroar", 2.50, "Earth Power → Glimmora", 19.34),
    ("Pelipper", "Dragonite", "Rock Tomb → Pelipper", 6.73, "Switch → Kingambit", 3.20),
...
@pytest.mark.parametrize("opp_a,opp_b,dec_a,wt_a,dec_b,wt_b", [
    ("Incineroar", "Sneasler", "Close Combat → Incineroar", 2.15, "Switch → Basculegion", 6.48),
    ...
    ("Whimsicott", "Garchomp", "Switch → Venusaur", 4.67, "Iron Head → Whimsicott", 4.32),
    ...
    ("Sneasler", "Kingambit", "Protect → ?", 2.00, "Switch → Garchomp", 5.35),
    ("Aerodactyl", "Garchomp", "Switch → Basculegion", 8.20, "Iron Head → Aerodactyl", 4.55),
    ("Lopunny", "Garchomp", "Protect → ?", 5.00, "Protect → ?", 15.00),
    ("Weavile", "Garchomp", "Protect → ?", 5.00, "Protect → ?", 2.00),
    ("Talonflame", "Garchomp", "Switch → Basculegion", 7.02, "Kowtow Cleave → Talonflame", 2.86),
    ("Charizard", "Incineroar", "Protect → ?", 5.00, "Switch → Aerodactyl", 5.95),
    ("Rotom-Wash", "Garchomp", "Switch → Garchomp", 3.90, "Kowtow Cleave → Rotom-Wash", 1.77),
