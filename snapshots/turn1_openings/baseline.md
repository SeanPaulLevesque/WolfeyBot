...
| 1.5 | Incineroar | Kingambit | Protect → ? `10.00` | Protect → ? `10.00` |
...
| 1.19 | Glimmora | Incineroar | Protect → ? `10.00` | Protect → ? `10.00` |
...
| 2.5 | Incineroar | Kingambit | Protect → ? `10.00` | Protect → ? `2.00` |
...
| 2.15 | Weavile | Garchomp | Protect → ? `10.00` | Protect → ? `2.00` |
...
| 2.19 | Glimmora | Incineroar | Protect → ? `10.00` | Protect → ? `2.00` |
...
| 3.14 | Lopunny | Garchomp | Switch → Basculegion `3.40` | Protect → ? `10.00` |
...
|---|---|---|---|---|
| 6.1 | Incineroar | Sneasler | Protect → ? `2.00` | Protect → ? `10.00` |
| 6.2 | Incineroar | Whimsicott | Close Combat → Incineroar `5.65` | Iron Head → Whimsicott `3.00` |
| 6.3 | Incineroar | Garchomp | Protect → ? `10.00` | Protect → ? `2.00` |
| 6.4 | Incineroar | Farigiraf | Protect → ? `10.00` | Protect → ? `2.00` |
...
| 6.7 | Farigiraf | Sneasler | Protect → ? `10.00` | Protect → ? `10.00` |
...
| 6.11 | Sneasler | Garchomp | Protect → ? `10.00` | Protect → ? `10.00` |
...
| 6.14 | Lopunny | Garchomp | Protect → ? `10.00` | Protect → ? `10.00` |
| 6.15 | Weavile | Garchomp | Protect → ? `10.00` | Protect → ? `2.00` |
| 6.16 | Talonflame | Garchomp | Switch → Basculegion `7.02` | Kowtow Cleave → Talonflame `4.79` |
| 6.17 | Charizard | Incineroar | Protect → ? `10.00` | Protect → ? `10.00` |
