...
| 1.13 | Aerodactyl | Garchomp | Switch → Basculegion `9.93` | Protect → ? `5.00` |
| 1.14 | Lopunny | Garchomp | Sacred Sword → Lopunny `7.50` | Protect → ? `7.50` |
| 1.15 | Weavile | Garchomp | Protect → ? `2.00` | Protect → ? `10.00` |
...
|---|---|---|---|---|
| 2.1 | Incineroar | Sneasler | Sacred Sword → Incineroar `15.00` | Switch → Basculegion `1.58` |
| 2.2 | Incineroar | Whimsicott | Sacred Sword → Incineroar `30.00` | Iron Head → Whimsicott `2.43` |
| 2.3 | Incineroar | Garchomp | Sacred Sword → Incineroar `15.00` | Switch → Basculegion `1.81` |
| 2.4 | Incineroar | Farigiraf | Sacred Sword → Incineroar `40.00` | Switch → Basculegion `1.89` |
| 2.5 | Incineroar | Kingambit | Sacred Sword → Incineroar `20.00` | Sacred Sword → Kingambit `1.28` |
| 2.6 | Incineroar | Aerodactyl | Protect → ? `10.00` | Switch → Basculegion `2.69` |
| 2.7 | Farigiraf | Sneasler | Psycho Cut → Sneasler `30.00` | Switch → Basculegion `1.57` |
...
| 2.12 | Sneasler | Kingambit | Sacred Sword → Kingambit `15.00` | Poltergeist → Sneasler `1.53` |
...
| 2.15 | Weavile | Garchomp | Protect → ? `2.00` | King's Shield → ? `2.00` |
...
|---|---|---|---|---|
| 3.1 | Incineroar | Sneasler | Sacred Sword → Incineroar `15.00` | Wave Crash → Sneasler `10.00` |
| 3.2 | Incineroar | Whimsicott | Psycho Cut → Whimsicott `4.93` | Wave Crash → Incineroar `20.00` |
| 3.3 | Incineroar | Garchomp | Sacred Sword → Incineroar `15.00` | Wave Crash → Garchomp `2.00` |
| 3.4 | Incineroar | Farigiraf | Sacred Sword → Incineroar `40.00` | Wave Crash → Farigiraf `4.77` |
| 3.5 | Incineroar | Kingambit | Sacred Sword → Kingambit `20.00` | Wave Crash → Incineroar `15.00` |
| 3.6 | Incineroar | Aerodactyl | Switch → Arcanine-Hisui `6.81` | Wave Crash → Incineroar `20.00` |
| 3.7 | Farigiraf | Sneasler | Psycho Cut → Sneasler `30.00` | Wave Crash → Farigiraf `3.18` |
...
| 3.11 | Sneasler | Garchomp | Psycho Cut → Sneasler `10.00` | Wave Crash → Garchomp `1.50` |
| 3.12 | Sneasler | Kingambit | Sacred Sword → Kingambit `15.00` | Wave Crash → Sneasler `10.00` |
| 3.13 | Aerodactyl | Garchomp | Switch → Pelipper `3.32` | Wave Crash → Aerodactyl `6.00` |
| 3.14 | Lopunny | Garchomp | Sacred Sword → Lopunny `10.00` | Wave Crash → Garchomp `1.50` |
| 3.15 | Weavile | Garchomp | Protect → ? `2.00` | Protect → ? `10.00` |
| 3.16 | Talonflame | Garchomp | Protect → ? `7.50` | Wave Crash → Talonflame `30.00` |
| 3.17 | Charizard | Incineroar | Sacred Sword → Incineroar `15.00` | Switch → Arcanine-Hisui `11.76` |
| 3.18 | Rotom-Wash | Garchomp | Leaf Blade → Rotom-Wash `20.00` | Wave Crash → Garchomp `3.00` |
| 3.19 | Glimmora | Incineroar | Sacred Sword → Incineroar `20.00` | Wave Crash → Glimmora `2.00` |
...
|---|---|---|---|---|
| 4.1 | Incineroar | Sneasler | Sacred Sword → Incineroar `10.00` | Air Slash → Sneasler `15.00` |
| 4.2 | Incineroar | Whimsicott | Sacred Sword → Incineroar `20.00` | Air Slash → Whimsicott `6.00` |
| 4.3 | Incineroar | Garchomp | Sacred Sword → Incineroar `10.00` | Dragon Pulse → Garchomp `3.00` |
| 4.4 | Incineroar | Farigiraf | Sacred Sword → Incineroar `30.00` | Dragon Pulse → Farigiraf `4.18` |
| 4.5 | Incineroar | Kingambit | Sacred Sword → Kingambit `15.00` | Dragon Pulse → Incineroar `1.77` |
| 4.6 | Incineroar | Aerodactyl | Switch → Basculegion `9.68` | Dragon Pulse → Aerodactyl `4.40` |
| 4.7 | Farigiraf | Sneasler | Sacred Sword → Farigiraf `2.35` | Air Slash → Sneasler `30.00` |
...
| 4.11 | Sneasler | Garchomp | Psycho Cut → Sneasler `7.50` | Dragon Pulse → Garchomp `2.00` |
| 4.12 | Sneasler | Kingambit | Sacred Sword → Kingambit `10.00` | Air Slash → Sneasler `15.00` |
| 4.13 | Aerodactyl | Garchomp | Switch → Basculegion `9.93` | Dragon Pulse → Garchomp `8.00` |
| 4.14 | Lopunny | Garchomp | Sacred Sword → Lopunny `7.50` | Dragon Pulse → Garchomp `2.00` |
...
| 4.17 | Charizard | Incineroar | Sacred Sword → Incineroar `10.00` | Switch → Arcanine-Hisui `3.66` |
| 4.18 | Rotom-Wash | Garchomp | Leaf Blade → Rotom-Wash `15.00` | Dragon Pulse → Garchomp `6.00` |
| 4.19 | Glimmora | Incineroar | Sacred Sword → Incineroar `15.00` | Dragon Pulse → Glimmora `2.76` |
...
|---|---|---|---|---|
| 6.1 | Incineroar | Sneasler | Protect → ? `10.00` | Switch → Gallade `3.16` |
| 6.2 | Incineroar | Whimsicott | Head Smash → Incineroar `30.00` | Iron Head → Whimsicott `2.43` |
| 6.3 | Incineroar | Garchomp | Protect → ? `10.00` | King's Shield → ? `2.00` |
| 6.4 | Incineroar | Farigiraf | Head Smash → Incineroar `40.00` | Switch → Basculegion `1.89` |
| 6.5 | Incineroar | Kingambit | Head Smash → Incineroar `20.00` | Switch → Gallade `7.83` |
| 6.6 | Incineroar | Aerodactyl | Head Smash → Incineroar `30.00` | Switch → Basculegion `2.69` |
...
| 6.11 | Sneasler | Garchomp | Protect → ? `10.00` | Switch → Gallade `3.16` |
| 6.12 | Sneasler | Kingambit | Protect → ? `10.00` | Switch → Gallade `12.63` |
| 6.13 | Aerodactyl | Garchomp | Switch → Basculegion `6.07` | Iron Head → Aerodactyl `5.20` |
| 6.14 | Lopunny | Garchomp | Protect → ? `10.00` | King's Shield → ? `10.00` |
| 6.15 | Weavile | Garchomp | Protect → ? `10.00` | Switch → Gallade `3.48` |
| 6.16 | Talonflame | Garchomp | Head Smash → Talonflame `8.00` | Poltergeist → Garchomp `3.03` |
| 6.17 | Charizard | Incineroar | Head Smash → Charizard `20.00` | Switch → Gallade `1.26` |
...
| 7.2 | Incineroar | Whimsicott | Head Smash → Whimsicott `6.00` | Wave Crash → Incineroar `20.00` |
| 7.3 | Incineroar | Garchomp | Switch → Gallade `3.20` | Wave Crash → Incineroar `10.00` |
| 7.4 | Incineroar | Farigiraf | Head Smash → Incineroar `40.00` | Wave Crash → Farigiraf `4.77` |
| 7.5 | Incineroar | Kingambit | Protect → ? `10.00` | Protect → ? `10.00` |
| 7.6 | Incineroar | Aerodactyl | Head Smash → Incineroar `30.00` | Wave Crash → Aerodactyl `4.00` |
...
| 7.12 | Sneasler | Kingambit | Switch → Gallade `11.80` | Protect → ? `10.00` |
...
| 7.15 | Weavile | Garchomp | Protect → ? `10.00` | Switch → Gallade `12.78` |
| 7.16 | Talonflame | Garchomp | Switch → Aegislash `3.20` | Wave Crash → Talonflame `30.00` |
| 7.17 | Charizard | Incineroar | Head Smash → Incineroar `20.00` | Wave Crash → Charizard `10.00` |
| 7.18 | Rotom-Wash | Garchomp | Switch → Gallade `4.04` | Wave Crash → Garchomp `3.00` |
| 7.19 | Glimmora | Incineroar | Head Smash → Incineroar `20.00` | Wave Crash → Glimmora `2.00` |
...
| 8.2 | Incineroar | Whimsicott | Head Smash → Incineroar `20.00` | Air Slash → Whimsicott `6.00` |
| 8.3 | Incineroar | Garchomp | Protect → ? `10.00` | Protect → ? `2.00` |
| 8.4 | Incineroar | Farigiraf | Head Smash → Incineroar `30.00` | Dragon Pulse → Farigiraf `4.18` |
| 8.5 | Incineroar | Kingambit | Head Smash → Incineroar `15.00` | Switch → Gallade `2.14` |
| 8.6 | Incineroar | Aerodactyl | Head Smash → Incineroar `20.00` | Dragon Pulse → Aerodactyl `4.40` |
...
| 8.15 | Weavile | Garchomp | Protect → ? `10.00` | Switch → Gallade `3.70` |
| 8.16 | Talonflame | Garchomp | Head Smash → Talonflame `6.00` | Dragon Pulse → Garchomp `8.00` |
| 8.17 | Charizard | Incineroar | Head Smash → Incineroar `15.00` | Dragon Pulse → Charizard `2.25` |
| 8.18 | Rotom-Wash | Garchomp | Switch → Gallade `4.04` | Dragon Pulse → Garchomp `6.00` |
| 8.19 | Glimmora | Incineroar | Head Smash → Incineroar `15.00` | Dragon Pulse → Glimmora `2.76` |
...
| 10.2 | Incineroar | Whimsicott | Iron Head → Whimsicott `2.43` | Wave Crash → Incineroar `30.00` |
| 10.3 | Incineroar | Garchomp | Switch → Gallade `1.40` | Wave Crash → Incineroar `15.00` |
| 10.4 | Incineroar | Farigiraf | Switch → Arcanine-Hisui `1.52` | Wave Crash → Incineroar `40.00` |
| 10.5 | Incineroar | Kingambit | King's Shield → ? `10.00` | Protect → ? `10.00` |
| 10.6 | Incineroar | Aerodactyl | Iron Head → Aerodactyl `2.60` | Wave Crash → Incineroar `30.00` |
...
| 10.12 | Sneasler | Kingambit | Switch → Gallade `12.63` | Protect → ? `10.00` |
...
| 10.15 | Weavile | Garchomp | Switch → Gallade `3.48` | Protect → ? `10.00` |
...
| 10.19 | Glimmora | Incineroar | Switch → Gallade `1.35` | Wave Crash → Incineroar `15.00` |
...
| 11.2 | Incineroar | Whimsicott | Switch → Arcanine-Hisui `1.55` | Air Slash → Whimsicott `6.00` |
| 11.3 | Incineroar | Garchomp | Switch → Basculegion `1.81` | Dragon Pulse → Garchomp `3.00` |
| 11.4 | Incineroar | Farigiraf | Switch → Basculegion `1.89` | Dragon Pulse → Farigiraf `4.18` |
| 11.5 | Incineroar | Kingambit | King's Shield → ? `10.00` | Switch → Gallade `2.14` |
| 11.6 | Incineroar | Aerodactyl | Switch → Basculegion `2.69` | Dragon Pulse → Aerodactyl `4.40` |
...
| 11.17 | Charizard | Incineroar | King's Shield → ? `10.00` | Switch → Arcanine-Hisui `3.66` |
...
| 12.2 | Incineroar | Whimsicott | Iron Head → Whimsicott `2.43` | Weather Ball → Incineroar `7.73` |
...
| 12.6 | Incineroar | Aerodactyl | Switch → Basculegion `3.97` | Weather Ball → Aerodactyl `6.00` |
...
| 12.17 | Charizard | Incineroar | Switch → Gallade `1.26` | Weather Ball → Charizard `20.00` |
...
|---|---|---|---|---|
| 13.1 | Incineroar | Sneasler | Wave Crash → Incineroar `10.00` | Air Slash → Sneasler `15.00` |
| 13.2 | Incineroar | Whimsicott | Wave Crash → Incineroar `20.00` | Air Slash → Whimsicott `6.00` |
| 13.3 | Incineroar | Garchomp | Wave Crash → Incineroar `10.00` | Dragon Pulse → Garchomp `3.00` |
| 13.4 | Incineroar | Farigiraf | Wave Crash → Incineroar `30.00` | Dragon Pulse → Farigiraf `4.18` |
| 13.5 | Incineroar | Kingambit | Protect → ? `10.00` | Switch → Gallade `2.14` |
| 13.6 | Incineroar | Aerodactyl | Wave Crash → Incineroar `20.00` | Dragon Pulse → Aerodactyl `4.40` |
| 13.7 | Farigiraf | Sneasler | Wave Crash → Farigiraf `3.18` | Air Slash → Sneasler `30.00` |
...
| 13.11 | Sneasler | Garchomp | Switch → Gallade `2.38` | Air Slash → Sneasler `10.00` |
...
| 13.14 | Lopunny | Garchomp | Wave Crash → Lopunny `7.50` | Dragon Pulse → Garchomp `2.00` |
| 13.15 | Weavile | Garchomp | Protect → ? `10.00` | Switch → Gallade `3.70` |
...
| 13.19 | Glimmora | Incineroar | Wave Crash → Incineroar `10.00` | Dragon Pulse → Glimmora `2.76` |
...
|---|---|---|---|---|
| 14.1 | Incineroar | Sneasler | Wave Crash → Incineroar `10.00` | Hurricane → Sneasler `20.00` |
| 14.2 | Incineroar | Whimsicott | Wave Crash → Incineroar `20.00` | Hurricane → Whimsicott `8.00` |
| 14.3 | Incineroar | Garchomp | Wave Crash → Incineroar `10.00` | Ice Beam → Garchomp `20.00` |
| 14.4 | Incineroar | Farigiraf | Wave Crash → Farigiraf `60.00` | Weather Ball → Incineroar `7.73` |
| 14.5 | Incineroar | Kingambit | Protect → ? `10.00` | Switch → Gallade `1.66` |
| 14.6 | Incineroar | Aerodactyl | Wave Crash → Incineroar `20.00` | Weather Ball → Aerodactyl `6.00` |
| 14.7 | Farigiraf | Sneasler | Wave Crash → Farigiraf `40.00` | Hurricane → Sneasler `40.00` |
...
| 14.11 | Sneasler | Garchomp | Wave Crash → Sneasler `7.50` | Ice Beam → Garchomp `20.00` |
...
| 14.14 | Lopunny | Garchomp | Wave Crash → Lopunny `7.50` | Ice Beam → Garchomp `15.00` |
...
| 14.17 | Charizard | Incineroar | Wave Crash → Incineroar `10.00` | Weather Ball → Charizard `20.00` |
| 14.18 | Rotom-Wash | Garchomp | Wave Crash → Rotom-Wash `2.98` | Ice Beam → Garchomp `40.00` |
| 14.19 | Glimmora | Incineroar | Wave Crash → Incineroar `10.00` | Weather Ball → Glimmora `4.00` |
...
|---|---|---|---|---|
| 15.1 | Incineroar | Sneasler | Switch → Gallade `2.80` | Hurricane → Sneasler `20.00` |
| 15.2 | Incineroar | Whimsicott | Air Slash → Whimsicott `4.00` | Weather Ball → Incineroar `7.73` |
| 15.3 | Incineroar | Garchomp | Switch → Basculegion `1.97` | Ice Beam → Garchomp `20.00` |
| 15.4 | Incineroar | Farigiraf | Dragon Pulse → Farigiraf `3.13` | Switch → Basculegion `8.27` |
| 15.5 | Incineroar | Kingambit | Switch → Gallade `2.14` | Weather Ball → Incineroar `3.87` |
| 15.6 | Incineroar | Aerodactyl | Switch → Basculegion `4.09` | Weather Ball → Aerodactyl `6.00` |
...
| 15.11 | Sneasler | Garchomp | Air Slash → Sneasler `7.50` | Ice Beam → Garchomp `20.00` |
...
| 15.14 | Lopunny | Garchomp | Air Slash → Lopunny `7.50` | Ice Beam → Garchomp `15.00` |
...
| 15.17 | Charizard | Incineroar | Switch → Gallade `1.34` | Weather Ball → Charizard `20.00` |
